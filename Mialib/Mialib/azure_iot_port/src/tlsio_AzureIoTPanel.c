...
//#include "azure_c_shared_utility/macro_utils.h"                 //zwj
...
MU_DEFINE_ENUM(TLSIO_MIA_STATE, TLSIO_MIA_STATE_VALUES);
//DEFINE_ENUM(TLSIO_MIA_STATE, TLSIO_MIA_STATE_VALUES);   //zwj
